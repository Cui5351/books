<script>
	...
	export default {
		setup() {
			let width=ref(uni.getSystemInfoSync().screenWidth)
			let height=ref(uni.getSystemInfoSync().screenHeight)
			let rect=ref(uni.getMenuButtonBoundingClientRect().height)
